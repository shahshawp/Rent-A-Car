...
//Postcode
    if (postcode == "" || postcode == "null") {
        ...
        errMsg = errMsg + "Your Postcode must be less than 5 digits\n";
        result = false;
    }
    

//Rental Duration
    if (rentalD == "" || rentalD == "null") {
        errMsg = errMsg + "Please Enter The Rental Duration\n";
        result = false;
    } else if (rentalD < 1) {
        errMsg = errMsg + "You Must Rent the Car For At Least 1 Day\n";
        result = false;
    }
    
    if (product == "" || product == "null") {
        errMsg = errMsg + "Please Choose Your Car\n";
        result = false;
    }
